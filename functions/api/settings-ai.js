...
export const getConfigAiApi = onCall({ region, cors: corsOrigins, ...runtimeOpts }, async (request) => {
...
export const saveConfigAiApi = onCall({ region, cors: corsOrigins, ...runtimeOpts }, async (request) => {
