...
import { requireAuth, requireAdmin } from "../utils/authHelpers.ts";
import { createAttachment } from "../../shared/schemas/entityFactory.ts";
 ...
 */
function validateAttachmentData(data: Record<string, unknown>) {
