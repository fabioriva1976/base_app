...
export const getConfigSmtpApi = onCall({ region, cors: corsOrigins, ...runtimeOpts }, async (request) => {
...
export const saveConfigSmtpApi = onCall({ region, cors: corsOrigins, ...runtimeOpts }, async (request) => {
