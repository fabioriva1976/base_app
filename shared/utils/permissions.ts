...
export function hasPermission(
  userRole: UserRole | UserRole[] | string | string[] | undefined | null,
 ...
 */
export function isAdmin(userRole: UserRole | UserRole[] | string | string[] | undefined | null): boolean {
  if (!userRole) return false;
 ...
 */
export function isSuperuser(userRole: UserRole | UserRole[] | string | string[] | undefined | null): boolean {
  if (!userRole) return false;
 ...
 */
export function isOperatore(userRole: UserRole | UserRole[] | string | string[] | undefined | null): boolean {
  if (!userRole) return false;
 ...
 */
export function getPermissions(userRole: UserRole | UserRole[] | string | string[]): Record<string, boolean> {
  const roles = Array.isArray(userRole) ? userRole : [userRole];
